...
namespace Biblioteca_examen
{
    public static class BaseDeDatos
    {
        ...
        public static void InsertarDeliberi(Deliberi deliberi)
        {
            try
            {


                string command = "INSERT INTO Productos(nombre,precio)" + $"VALUES(Nombre , Precio, Direccion )";

                SqlCommand sqlCommand = new SqlCommand(command, sqlConnection);// generar un objeto


                sqlCommand.Parameters.AddWithValue("Nombre", deliberi.Nombre);
                sqlCommand.Parameters.AddWithValue("Precio", deliberi.Precio);
                sqlCommand.Parameters.AddWithValue("Descripcion", deliberi.Direccion);
        ...
        public static List<Deliberi> GetDeliberi()
        {
            List<Deliberi> auxDeliberi = new List<Deliberi>();
            try
            {
                ...
                comandito.Connection = sqlConnection;
                comandito.CommandType = CommandType.Text;
                comandito.CommandText = "SELECT * FROM Deliberi";
                ...
                while (datosDevueltos.Read())
                {
                    auxDeliberi.Add(new Deliberi(datosDevueltos["Nombre"].ToString(),
                                              datosDevueltos["Direccion"].ToString(),
                                             float.Parse(datosDevueltos["Precio"].ToString())));
